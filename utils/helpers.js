...
module.exports = {
    ...
    render_mini_1: data => {
        ...
        const dates = data.map(el => {
            ...
            return (`<div id="mini-col-${el}"  class="col half-coll text-center d-flex flex-wrap justify-content-center p-2" ><div style='height: 27px'><p  id=mini-date-${el} class='d-flex align-self-center'>${el}</p></div><div class=' col-12 d-flex justify-content-start align-items-center text-center'><div class="col-10 d-flex flex-wrap text-center"'><span id='event-${el}'><!--INSERT EVENT ICONS HERE --></span></div></div></div>`)
        }).join(" ")
        return dates
    },
