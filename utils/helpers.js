...
module.exports = {
    ...
    render_mini_1: data => {
        ...
        const dates = data.map(el => {
            ...
            return (`<div id="mini-col-${el}"  class="col half-coll text-center d-flex flex-wrap justify-content-between align-items-center p-2"><div style="max-height:auto;" class='d-flex  justify-content-center align-items-center me-2'><p  id=mini-date-${el} class='d-flex align-self-center'>${el}</p><span style="max-height: auto;" class"d-flex align-self-center text-center ms-2"><span id='event-${el}' mt-1'><!--INSERT EVENT ICONS HERE --></span></span></div></div>`)
        }).join(" ")
        return dates
    },
